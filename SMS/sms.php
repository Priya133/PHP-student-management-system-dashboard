                ...
                <div class="block-content block-content-narrow">
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        ...
                        if ($whom == 1)
                            $select_para = "stu_mob";
                        elseif ($whom == 2) {
                            $select_para = "stu_parent_mob";
                        }

                        $sql = 'SELECT '.$select_para.' FROM  `students` WHERE stu_id IN ( SELECT stu_id FROM stu_cs WHERE cs_id = '.$cs_id.' )';
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material">
                                            <textarea class="form-control" id="message" name="message" rows="3" placeholder="Please add a message"></textarea>
                                            <label for="material-textarea-small">Message</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
