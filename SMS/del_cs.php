    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
                Delete Course <small></small>
            </h1>
        </div>
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="home.php">Dashboard</a></li>
                <li><a href="cs.php?id=<?php echo $sel_user_id; ?>">Courses</a></li>
                <li><a class="link-effect" href="">Delete Course</a></li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="block-content block-content-narrow">
                    ...
                    <?php 
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if (del_cs($sel_user_id, $mysqli) == true){                       
                                echo("<script>location.href = 'cs.php';</script>");                      
                            }
                            else{
                                
                                echo "Course could not be deleted. Please try again!";
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <div class="form-material">
                                    <label for="val-username2">Are you sure you want to delete course (<?php echo $row['cs_name'] ?>) ?</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
