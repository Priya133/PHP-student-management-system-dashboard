...
$one                               = new Template('Student Management System', '1.0', 'assets'); // Name, version and assets folder's name

// Global Meta Data
$one->author                       = 'Student Management System';
...
$one->main_nav                     = array(
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Users Section</span>',
        'type'  => 'heading'
    ),
    array(
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Students Section</span>',
        'type'  => 'heading'
    ),
    array(
        'name'  => '<span class="sidebar-mini-hide">Students</span>',
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Courses Section</span>',
        'type'  => 'heading'
    ),
    array(
        'name'  => '<span class="sidebar-mini-hide">Courses</span>',
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Attendance Report</span>',
        'type'  => 'heading'
    ),
    array(
        'name'  => '<span class="sidebar-mini-hide">Report</span>',
        'icon'  => 'si si-notebook',
        'url'   => 'report.php'
    )
    /*array(
        'name'  => '<span class="sidebar-mini-hide">Send SMS</span>',
        'type'  => 'heading'
    )
    array(
        'name'  => '<span class="sidebar-mini-hide">SMS</span>',
        'icon'  => 'si si-envelope',
        'url'   => 'sms.php'
    ),
    array(
        'name'  => '<span class="sidebar-mini-hide">Marks</span>',
        'icon'  => 'si si-calculator',
        'url'   => 'marks.php'
    )*/
    // array(
    //     'name'  => '<span class="sidebar-mini-hide">Extra Section</span>',
    //     'type'  => 'heading'
    // ),
    // array(
